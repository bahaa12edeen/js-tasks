...
function stringItUp(arr){
  ...
  fmap = arr.map(function(val){
      let test = String(val);
         console.log(test+" / type of: "+ typeof(test));
     });
}
console.log("Q2: ");
stringItUp(array1);
...
function capitalizeNames(arr){
  // your code here
  fmap = arr.map(function(val){
      let test = val.charAt(0).toUpperCase() + val.slice(1);
         console.log(test);
     });
}
console.log("Q3: ");
...
function namesOnly(arr){
    // your code here
    arrayName = arr.map(function(val){
      let test = val.name;
         return (test);
     });
...
function makeStrings(arr){
  ...
  arrayName = arr.map(function(val){
      let test = val.name;
         if(val.age >= 18){
            return (test + " can go to The Matrix");
         }else{
            return (test + " is under age!!");
         }
     });
...
doubleValues([1,-2,-3]);
  ...
  */
  ...
  function valTimesIndex(arr){
     // your code here   
     fmap = arr.map(function(val, index){
         return(val*index);
     });
...
valTimesIndex([1,-2,-3]);
 ...
 function extractFullName(arr){
    // your code here 
    fmap = arr.map(item => item.first + " " + item.last);
    console.log(fmap);
}
console.log("Q10: ");
